...
import ext.pay.weixin.v3.WxpayException;
import ext.pay.weixin.v3.WxpayProtocolException;
import ext.pay.weixin.v3.resps.ResponseBase;
import ext.pay.weixin.v3.util.XMLParser;
import org.apache.http.client.fluent.Request;
import org.apache.http.entity.ContentType;
import play.Logger;
import util.crypto.CryptoBase;
import util.text.URLBuilder;
...
public abstract class RequestBase {
     ...
     *
     * @throws java.io.UnsupportedEncodingException if your runtime does not support utf-8.
     */
    ...
    /**
     * @throws ext.pay.weixin.v3.WxpayException         never occur, since 0.1.0 WxpayException is parsed by ResponseBase.getErrorCode()
     * @throws ext.pay.weixin.v3.WxpayProtocolException never occur, since 0.1.0 WxpayProtocolException is parsed by ResponseBase.getErrorCode()
     */
    public ResponseBase execute(String urlBase, List<String> paramNames)
        ...
        try {
            ...
            String xml = this.toXml(paramNames);
            Logger.info("execute weixin pay xml=" + xml);
            ...
            Logger.info("execute weixin pay result=" + content);
