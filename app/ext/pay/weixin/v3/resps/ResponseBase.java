...
public class ResponseBase
{
  ...
  // VERIFY
     ...
     * @exception java.io.UnsupportedEncodingException if your runtime does not support utf-8.
     */
        ...
        throws UnsupportedEncodingException
    {
        ...
        Logger.info("signMD5 source=" + sb.toString() + ", sign=" + sign);
        ...
        throws UnsupportedEncodingException
    {
        ...
        Logger.info("weixin sign=" + stated);
        return(
